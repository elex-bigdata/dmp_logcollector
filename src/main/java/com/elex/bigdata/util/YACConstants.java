...
public class YACConstants {
    ...
    public static final String url_filter_keywords = "callback=|\\.xml|=http|google-analytics|googlebanner|ad\\.|ads\\.|ad2\\.|\\.ad|192\\.168\\.|\\.ytimg\\.com|ajax|api|image|favicon|\\.doubleclick|s\\.youtube\\.com|&async=|=async&|livetr\\.gostream\\.nl|---|___|/cdn|cdn\\.|adserver|graph\\.facebook\\.com";
